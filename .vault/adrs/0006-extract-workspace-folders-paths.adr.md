...
deprecated:
  date: "2026-08-24"
  reason: "Workspace-folder-paths extraction (part of F3 multi-root) dropped in the patched/main2 rebuild (user decision 2026-08-24, ADR-0010). Kept for historical record."
