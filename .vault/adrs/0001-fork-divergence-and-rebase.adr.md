...
deprecated:
  date: "2026-08-24"
  reason: "Rebase governance superseded by the patched/main2 rebuild decision (ADR-0010): fork rebuilt on latest upstream main keeping only F5/F6/F8/F12/F13; patched/main frozen as rollback."
  superseded_by: "adrs/0010-rebuild-patched-main2.adr.md"
---

# ADR-0001: Fork Divergence and Rebase Strategy for better-openchamber

> **SUPERSEDED by [ADR-0010](./0010-rebuild-patched-main2.adr.md) (2026-08-24):** the
> rebase-based sync strategy below was replaced by a fresh rebuild of the fork as
> `patched/main2` on latest upstream main, carrying only the better-opencode integration
> features (F5, F6, F8, F12, F13). This record is kept for history.
